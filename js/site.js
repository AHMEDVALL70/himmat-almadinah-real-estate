...
const I18N = {
  ar: {
    ...
    val_honesty_text:"هذا المؤشر ناتج معادلة حسابية شفافة (سعر المتر × المساحة مع معاملات تعديل) — مو نموذج ذكاء اصطناعي يخمّن. سعر المتر نفسه إما من صفقات حقيقية موثّقة (وزارة العدل عبر رغدان) لو متوفرة لهذا الحي تحديداً، أو متوسط عام للمدينة لو لا — النتيجة أدناه توضح أي الحالتين تنطبق. اعتبره نقطة انطلاق للنقاش، لا تقييماً معتمداً رسمياً.",
